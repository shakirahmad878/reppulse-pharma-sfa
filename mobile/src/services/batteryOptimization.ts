 ...
 * Guides users to whitelist RepPulse so 15-minute background location telemetry continues unimpeded.
 */
...
export class BatteryOptimizationService {
  ...
  public static getExemptionInstructions(): {
    ...
    return {
      ...
      description: 'To record automated 15-minute clinic check-ins while your phone screen is turned off in your pocket, RepPulse requires "Unrestricted" battery usage.',
      steps: [
        '1. Go to your Phone Settings -> Apps -> RepPulse',
